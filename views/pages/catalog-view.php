			...
			<div class="list-group">
				<div class="list-group-item">
					<div class="row-picture">
						<img class="circle" src="<?php ECHO SERVERURL; ?>views/assets/book/book-default.png" alt="icon">
					</div>
				...
				<div class="list-group-item">
					<div class="row-picture">
						<img src="<?php ECHO SERVERURL; ?>views/assets/book/book-cover.jpg" alt="icon">
					</div>
					<div class="row-content">
